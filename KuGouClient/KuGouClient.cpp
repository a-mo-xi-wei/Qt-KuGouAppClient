...
KuGouClient::KuGouClient(MainWindow *parent)
    : MainWindow(parent), ui(new Ui::KuGouClient),
...
void KuGouClient::initUi()
{
    ...
    connect(m_searchResultWidget.get(), &SearchResultWidget::searchEnable, this,
...
void KuGouClient::initPlayWidget()
{
    ...
    connect(this, &KuGouClient::curPlaySongNameChange, [this, song_name_text_toolTip](const QString &songName) {
        ...
        if (fm.horizontalAdvance(songName) > 60)
            ui->song_name_text->setFixedWidth(
                fm.horizontalAdvance(songName) > maxWidth ? maxWidth : fm.horizontalAdvance(songName));
        else
        ...
        /// qDebug()<<"elidedText: "<<elidedText<<" 歌曲文本长度："<<fm.horizontalAdvance(songName) << "
        /// ui->song_name_text->width() : "<<ui->song_name_text->width();
    ...
    connect(this, &KuGouClient::curPlaySingerChange, [this, singer_text_toolTip](const QString &singerName) {
        ...
        if (fm.horizontalAdvance(singerName) > 60)
            ui->singer_text->setFixedWidth(
                fm.horizontalAdvance(singerName) > maxWidth ? maxWidth : fm.horizontalAdvance(singerName));
        else
    ...
    connect(this->m_player, &VideoPlayer::durationChanged, this,
...
QWidget *KuGouClient::createPage(int id)
{
    ...
    case 0: // Live
        if (!m_live)
        {
            ...
            connect(
                m_live.get(), &Live::initialized, this,
                [this] {
    ...
    case 1: // ListenBook
        if (!m_listenBook)
        {
            ...
            connect(
                m_listenBook.get(), &ListenBook::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 2: // Search
        if (!m_search)
        {
            ...
            connect(
                m_search.get(), &Search::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 3: // RecommendForYou
        if (!m_recommendForYou)
        {
            ...
            connect(
                m_recommendForYou.get(), &RecommendForYou::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 4: // MusicRepository
        if (!m_musicRepository)
        {
            ...
            connect(
                m_musicRepository.get(), &MusicRepository::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 5: // Channel
        if (!m_channel)
        {
            ...
            connect(
                m_channel.get(), &Channel::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 6: // Video
        if (!m_video)
        {
            ...
            connect(
                m_video.get(), &Video::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 7: // AiChat
        if (!m_aiChat)
        {
            ...
            connect(
                m_aiChat.get(), &AiChat::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 8: // SongList
        if (!m_songList)
        {
            ...
            connect(
                m_songList.get(), &SongList::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 9: // DailyRecommend
        if (!m_dailyRecommend)
        {
            ...
            connect(
                m_dailyRecommend.get(), &DailyRecommend::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 10: // MyCollection
        if (!m_collection)
        {
            ...
            connect(m_collection.get(), &MyCollection::find_more_music, this,
                    [this] { ui->music_repository_toolButton->click(); });
            connect(
                m_collection.get(), &MyCollection::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 11: // LocalDownload
        if (!m_localDownload)
        {
            ...
            connect(m_localDownload.get(), &LocalDownload::find_more_music, this,
                    [this] { ui->music_repository_toolButton->click(); });
            ...
            connect(
                m_localDownload.get(), &LocalDownload::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 12: // MusicCloudDisk
        if (!m_musicCloudDisk)
        {
            ...
            connect(m_musicCloudDisk.get(), &MusicCloudDisk::find_more_music, this,
                    [this] { ui->music_repository_toolButton->click(); });
            connect(
                m_musicCloudDisk.get(), &MusicCloudDisk::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 13: // PurchasedMusic
        if (!m_purchasedMusic)
        {
            ...
            connect(m_purchasedMusic.get(), &PurchasedMusic::find_more_music, this,
                    [this] { ui->music_repository_toolButton->click(); });
            connect(
                m_purchasedMusic.get(), &PurchasedMusic::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 14: // RecentlyPlayed
        if (!m_recentlyPlayed)
        {
            ...
            connect(m_recentlyPlayed.get(), &RecentlyPlayed::find_more_music, this,
                    [this] { ui->music_repository_toolButton->click(); });
            connect(m_recentlyPlayed.get(), &RecentlyPlayed::find_more_channel, this,
                    [this] { ui->channel_toolButton->click(); });
            connect(
                m_recentlyPlayed.get(), &RecentlyPlayed::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    case 15: // AllMusic
        if (!m_allMusic)
        {
            ...
            connect(m_allMusic.get(), &AllMusic::find_more_music, this,
                    [this] { ui->music_repository_toolButton->click(); });
            connect(
                m_allMusic.get(), &AllMusic::initialized, this,
                [this] {
                    this->m_isInitialized = true;
                    enableButton(true);
                },
    ...
    else
    {
        ...
        if (mediaStatusConnection)
        {
            ...
            mediaStatusConnection = connect(this->m_player, &VideoPlayer::audioFinish, this, [this] {
                ...
                // @note 未使用，保留用于调试
                // qDebug() << "正常结束";
                if (ui->stackedWidget->currentWidget() == static_cast<QWidget *>(this->m_localDownload.get()) &&
                    this->m_localDownload)
                    this->m_localDownload->audioFinished(); ///< 通知本地下载组件
                if (ui->stackedWidget->currentWidget() == static_cast<QWidget *>(this->m_searchResultWidget.get()) &&
...
void KuGouClient::on_stander_pushButton_clicked()
{
    if (this->m_player->getMusicPath().isEmpty())
    {
        ElaMessageBar::information(ElaMessageBarType::BottomRight, "Info",
                                   QStringLiteral("音质选择功能 暂未实现 敬请期待"), 1000,
                                   this->window()); ///< 显示未实现提示
        return;
    }
}
...
void KuGouClient::on_acoustics_pushButton_clicked()
{
    if (this->m_player->getMusicPath().isEmpty())
    {
        ElaMessageBar::information(ElaMessageBarType::BottomRight, "Info", QStringLiteral("音效功能 暂未实现 敬请期待"),
                                   1000,
                                   this->window()); ///< 显示未实现提示
        return;
    }
...
void KuGouClient::on_song_queue_toolButton_clicked()
{
    ...
    {
        ElaMessageBar::information(ElaMessageBarType::BottomRight, "Info",
                                   QStringLiteral("播放队列功能 暂未实现 敬请期待"), 1000,
                                   this->window()); ///< 显示未实现提示
        return;
    }
}
