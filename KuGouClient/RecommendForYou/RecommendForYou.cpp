...
void RecommendForYou::initClassifyWidget() const
{
    ...
    ui->recommend_toolButton->setIcon(QIcon(QStringLiteral(":/RecommendForYou/Res/recommend/tabIcon/rili.svg"))); ///< 设置推荐按钮图标
    ...
    ui->ranking_list_toolButton->setIcon(QIcon(QStringLiteral(":/RecommendForYou/Res/recommend/tabIcon/rank.svg"))); ///< 设置排行榜按钮图标
    ...
    ui->classify_toolButton->setIcon(QIcon(QStringLiteral(":/RecommendForYou/Res/recommend/tabIcon/classification.svg"))); ///< 设置分类按钮图标
    ui->classify_toolButton->setEnterIconSize(QSize(40, 40)); ///< 设置悬停图标大小
    ui->classify_toolButton->setLeaveIconSize(QSize(35, 35)); ///< 设置离开图标大小

    ui->scene_music_toolButton->setIcon(QIcon(QStringLiteral(":/RecommendForYou/Res/recommend/tabIcon/shafa.svg"))); ///< 设置场景音乐按钮图标
    ...
    ui->music_quality_toolButton->setIcon(QIcon(QStringLiteral(":/RecommendForYou/Res/recommend/tabIcon/dish.svg"))); ///< 设置音乐品质按钮图标
