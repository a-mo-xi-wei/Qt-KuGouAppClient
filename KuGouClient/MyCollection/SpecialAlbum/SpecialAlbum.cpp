/**
* @file SpecialAlbum.cpp
 * @brief 实现 SpecialAlbum 类，管理专辑界面
 * @author WeiWang
 * @date 2024-11-14
 * @version 1.0
 */
...
{
    ui->setupUi(this);
    QFile file(GET_CURRENT_DIR + QStringLiteral("/special.css")); ///< 加载样式表
 ...
 * @note 触发搜索更多音乐的信号
 */
void SpecialAlbum::on_search_pushButton_clicked()
{
