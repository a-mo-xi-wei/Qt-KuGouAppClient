...
void MVWidget::on_more_pushButton1_clicked() {
    ElaMessageBar::information(ElaMessageBarType::BottomRight,"Info",
                QString("%1 功能未实现 敬请期待").arg(ui->more_pushButton1->text().left(ui->more_pushButton1->text().size() - 2)),1000,this->window());
}
...
void MVWidget::on_more_pushButton4_clicked() {
    ElaMessageBar::information(ElaMessageBarType::BottomRight,"Info",
                QString("%1 功能未实现 敬请期待").arg(ui->more_pushButton4->text().left(ui->more_pushButton4->text().size() - 2)),1000,this->window());
}

void MVWidget::on_more_pushButton5_clicked()  {
    ElaMessageBar::information(ElaMessageBarType::BottomRight,"Info",
                QString("%1 功能未实现 敬请期待").arg(ui->more_pushButton5->text().left(ui->more_pushButton5->text().size() - 2)),1000,this->window());
}
