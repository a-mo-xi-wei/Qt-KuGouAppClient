...
#if defined(RECENTLYSINGLESONG_LIBRARY)
#define RECENTLYSINGLESONG_EXPORT Q_DECL_EXPORT
#else
#define RECENTLYSINGLESONG_EXPORT Q_DECL_IMPORT
#endif
...
class RECENTLYSINGLESONG_EXPORT RecentlySingleSong : public QWidget {
    Q_OBJECT
