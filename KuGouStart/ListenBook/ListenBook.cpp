...
void ListenBook::initUi() {
    ...
    //显示隐藏按钮
    ui->indicator_toolButton->setStyleSheet(R"(QToolButton{background-color:rgba(255,255,255,0);
                                                border-image:url(:/ListenBook/Res/listenbook/up-black.svg);}
                                                 QToolButton:hover{border-image:url(:/ListenBook/Res/listenbook/up-blue.svg);}})");
        ...
        if (checked) {
            ui->indicator_toolButton->setStyleSheet(R"(QToolButton{background-color:rgba(255,255,255,0);
                                                border-image:url(:/ListenBook/Res/listenbook/down-black.svg);}
                                                 QToolButton:hover{border-image:url(:/ListenBook/Res/listenbook/down-blue.svg);}})");
        } else {
            ui->indicator_toolButton->setStyleSheet(R"(QToolButton{background-color:rgba(255,255,255,0);
                                                border-image:url(:/ListenBook/Res/listenbook/up-black.svg);}
                                                 QToolButton:hover{border-image:url(:/ListenBook/Res/listenbook/up-blue.svg);}})");
