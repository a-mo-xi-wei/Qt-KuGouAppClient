...
GalleryPhotoWidget::GalleryPhotoWidget(const GalleryPhotoData& data, QWidget *parent) : WaterZoomButton("", parent)
{
...
void GalleryPhotoWidget::paintEvent(QPaintEvent *event)
{
    ...
    const QRect f_rect = fm.boundingRect(QRect(rect.left(),rect.bottom()+line_height*1.5,rect.width(),0),Qt::TextWordWrap,subTitle);
