...
private:
    ...
    QString _api_key = "sk-vsxdkxaistusrfjqktlkdykkqeqybyiykbezxrbfdpmkrfie";//填入自己的硅基流动的API,参考 https://gitee.com/a-mo-xi-wei/qt6-access-deepseek#%E4%BB%8B%E7%BB%8D
    QString _read_text;
