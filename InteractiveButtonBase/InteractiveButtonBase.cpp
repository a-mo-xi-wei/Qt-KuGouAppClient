...
InteractiveButtonBase::InteractiveButtonBase(const QString &text, QWidget *parent)
    ...
    InteractiveButtonBase::setText(text);
}

/**
 * 图标类型的按钮
 */
InteractiveButtonBase::InteractiveButtonBase(const QIcon &icon, QWidget *parent)
    : InteractiveButtonBase(parent) {
    InteractiveButtonBase::setIcon(icon);
}
...
InteractiveButtonBase::InteractiveButtonBase(const QPixmap &pixmap, QWidget *parent)
    : InteractiveButtonBase(parent) {
    InteractiveButtonBase::setPixmap(pixmap);
}

InteractiveButtonBase::InteractiveButtonBase(const QIcon &icon, const QString &text, QWidget *parent)
    : InteractiveButtonBase(parent) {
    InteractiveButtonBase::setIcon(icon);
    InteractiveButtonBase::setText(text);
}
 ...
 * @param text 按钮文字
 */
void InteractiveButtonBase::setText(const QString &text) {
    this->text = text;
    ...
    if (text_dynamic_size) {
        if (font_size <= 0) {
            ...
            setMinimumSize(fm.horizontalAdvance(text) + fore_paddings.left + fore_paddings.right,
                           fm.lineSpacing() + fore_paddings.top + fore_paddings.bottom);
        } else {
            QFont font;
 ...
 * @param path 图标路径文本
 */
void InteractiveButtonBase::setIconPath(const QString &path) {
    setIcon(QIcon(path));
}
 ...
 * @param path 图标路径文本
 */
void InteractiveButtonBase::setPixmapPath(const QString &path) {
 ...
 * @param icon 图标
 */
void InteractiveButtonBase::setIcon(const QIcon &icon) {
    if (model == PaintModel::None)
 ...
 * @param size   图标尺寸
 */
void InteractiveButtonBase::setPaintAddIn(QPixmap pixmap, Qt::Alignment align, const QSize &size) {
 ...
 * @param e 开关
 */
void InteractiveButtonBase::setSelfEnabled(const bool &e) {
    self_enabled = e;
}
 ...
 * @param e 开关
 */
void InteractiveButtonBase::setParentEnabled(const bool &e) {
    parent_enabled = e;
 ...
 * @param e 开启
 */
void InteractiveButtonBase::setForeEnabled(const bool &e) {
    fore_enabled = e;
}
 ...
 * @param d 动画时长（毫秒）
 */
void InteractiveButtonBase::setHoverAniDuration(const int &d) {
 ...
 * @param d 动画时长（毫秒）
 */
void InteractiveButtonBase::setPressAniDuration(const int &d) {
 ...
 * @param d 动画时长（毫秒）
 */
void InteractiveButtonBase::setClickAniDuration(const int &d) {
 ...
 */
void InteractiveButtonBase::setWaterAniDuration(const int &press, const int &release, const int &finish) {
 ...
 * @param enable 开关
 */
void InteractiveButtonBase::setWaterRipple(const bool &enable) {
 ...
 * @param enable 开关
 */
void InteractiveButtonBase::setJitterAni(const bool &enable) {
 ...
 * @param enable 开关
 */
void InteractiveButtonBase::setUnifyGeometry(const bool &enable) {
 ...
 * @param bg 背景颜色
 */
void InteractiveButtonBase::setBgColor(const QColor &bg) {
    setNormalColor(bg);
    update();
}
 ...
 */
void InteractiveButtonBase::setBgColor(const QColor &hover, const QColor &press) {
    if (hover != Qt::black)
        setHoverColor(hover);
    if (press != Qt::black)
        setPressColor(press);
 ...
 * @param color 背景颜色
 */
void InteractiveButtonBase::setPressColor(const QColor &color) {
    press_bg = color;
}
 ...
 * @param color 图标颜色
 */
void InteractiveButtonBase::setIconColor(const QColor &color) {
    icon_color = color;
 ...
 * @param color 背景颜色
 */
void InteractiveButtonBase::setFocusBg(const QColor &color) {
 ...
 * @param color 边框颜色
 */
void InteractiveButtonBase::setFocusBorder(const QColor &color) {
    setFocusPolicy(Qt::StrongFocus);
    focus_border = color;
}
 ...
 * @param f 文字大小
 */
void InteractiveButtonBase::setFontSize(const int &f) {
    ...
    {
        auto ani = new QPropertyAnimation(this, "font_size");
 ...
 * @return 临时字体大小
 */
int InteractiveButtonBase::getFontSizeT() const {
    return font_size;
}
 ...
 * @param f 临时字体大小
 */
void InteractiveButtonBase::setFontSizeT(const int &f) {
    this->font_size = f;
    QFont font(this->font());
    font.setPointSize(f);
    setFont(font);
...
void InteractiveButtonBase::setHover() {
    if (!hovering && inArea(mapFromGlobal(QCursor::pos()))) {
        auto enterEvent = new QEvent(QEvent::Enter);
        InteractiveButtonBase::enterEvent(static_cast<QEnterEvent *>(enterEvent));
    }
}
 ...
 * @param r 半径
 */
void InteractiveButtonBase::setRadius(const int &r) {
    radius_x = radius_y = r;
}
 ...
 * @param ry Y半径
 */
void InteractiveButtonBase::setRadius(const int &rx, const int &ry) {
    radius_x = rx;
    radius_y = ry;
}
 ...
 * @param x 线条粗细
 */
void InteractiveButtonBase::setBorderWidth(const int &x) {
    border_width = x;
}
 ...
 * @param dis 不可用
 */
void InteractiveButtonBase::setDisabled(const bool &dis) {
 ...
 * @param b 底边空白
 */
void InteractiveButtonBase::setPaddings(const int &l, const int &r, const int &t, const int &b) {
 ...
 * @param v 纵向
 */
void InteractiveButtonBase::setPaddings(const int &h, const int &v) {
 ...
 * @param x 一样大小的四边留白
 */
void InteractiveButtonBase::setPaddings(const int &x) {
 ...
 * @param x 0~1.0，越大越空
 */
void InteractiveButtonBase::setIconPaddingProper(const double &x) {
    icon_padding_proper = x;
    int short_side = min(geometry().width(), geometry().height()); // 短边
    // 非固定的情况，尺寸大小变了之后所有 padding 都要变
    int padding = static_cast<int>(short_side * icon_padding_proper);
    //static_cast<int>(short_side * (1 - GOLDEN_RATIO) / 2);
 ...
 * @param d 开关
 */
void InteractiveButtonBase::setTextDynamicSize(const bool &d) {
    text_dynamic_size = d;
}
 ...
 */
void InteractiveButtonBase::setFixedTextPos(const bool &f) {
    fixed_fore_pos = f;
}
 ...
 * @param f [description]
 */
void InteractiveButtonBase::setFixedForePos(const bool &f) {
    fixed_fore_pos = f;
}
 ...
 * @param addin 留白的像素大小
 */
void InteractiveButtonBase::setFixedForeSize(const bool &f, const int &addin) {
    fixed_fore_size = f;
 ...
 * @param l 开关
 */
void InteractiveButtonBase::setLeaveAfterClick(const bool &l) {
 ...
 * @param e 开关
 */
void InteractiveButtonBase::setDoubleClicked(const bool &e) {
    double_clicked = e;
 ...
 * 动画时是否自动设置文字的颜色
 */
void InteractiveButtonBase::setAutoTextColor(const bool &a) {
 ...
 */
void InteractiveButtonBase::setPretendFocus(const bool &f) {
    focusing = f;
    update();
}
 ...
 * 开启后临时屏蔽，记得在动画结束后关闭
 */
void InteractiveButtonBase::setBlockHover(const bool &b) {
    _block_hover = b;
    if (b && hovering)
        leaveEvent(nullptr);
}
 ...
 * @param enable 开关
 */
void InteractiveButtonBase::setShowAni(const bool &enable) {
 ...
 * @param s 状态
 */
void InteractiveButtonBase::setState(const bool &s) {
    _state = s;
    update();
}
 ...
 * @return 状态
 */
bool InteractiveButtonBase::getState() const {
    return _state;
}
...
void InteractiveButtonBase::simulateStatePress(bool s, bool a) {
    ...
    mousePressEvent(new QMouseEvent(QMouseEvent::Type::None,
        QPoint(size().width() / 2, size().height() / 2),
        QCursor::pos(),Qt::LeftButton, Qt::NoButton, Qt::NoModifier));

    mouseReleaseEvent(new QMouseEvent(QMouseEvent::Type::None,
        QPoint(size().width() / 2, size().height() / 2),
        QCursor::pos(),Qt::LeftButton, Qt::NoButton, Qt::NoModifier));
...
void InteractiveButtonBase::mousePressEvent(QMouseEvent *event) {
    ...
    if (event->button() == Qt::LeftButton) {
        ...
        if (water_animation) {
            if (!waters.empty() && waters.last().release_timestamp == 0) // 避免两个按键同时按下
...
void InteractiveButtonBase::mouseReleaseEvent(QMouseEvent *event) {
    if (pressing && event->button() == Qt::LeftButton) {
        ...
        if (water_animation && !waters.empty()) {
...
void InteractiveButtonBase::paintEvent(QPaintEvent *event) {
    ...
    } else if (water_animation && !waters.empty()) // 水波纹，且至少有一个水波纹
    {
    ...
    if (fore_enabled/*针对按钮设置*/ && show_foreground/*针对动画设置*/) {
        ...
        // 绘制额外内容（可能被前景覆盖）
        if (paint_addin.enable) {
            int l = fore_paddings.left, t = fore_paddings.top, r = size().width() - fore_paddings.right, b =
                    size().height() - fore_paddings.bottom;
            int small_edge = min(size().height(), size().width());
            int pw = paint_addin.size.width()
                         ? paint_addin.size.width()
                         : small_edge - fore_paddings.left - fore_paddings.right;
            int ph = paint_addin.size.height()
                         ? paint_addin.size.height()
                         : small_edge - fore_paddings.top - fore_paddings.bottom;
        ...
        } else if (align == Qt::AlignCenter && model != PaintModel::Text && !fixed_fore_size) // 默认的缩放动画
        {
            ...
            if (click_ani_progress != 0) // 图标缩放
            {
                ...
                delta_x = static_cast<int>(rect.width() * pro); // (100-show_ani_progress) / 100;
                delta_y = static_cast<int>(rect.height() * pro); // (100-show_ani_progress) / 100;
            }
            if (delta_x || delta_y)
        ...
        } else if (model == IconText || model == PixmapText) // 强制左对齐；左图标中文字
        {
            ...
            icon_rect.moveTo(icon_rect.left() - quick_sqrt(offset_pos.x()),
                             icon_rect.top() - quick_sqrt(offset_pos.y()));
...
QPainterPath InteractiveButtonBase::getWaterPainterPath(InteractiveButtonBase::Water water) {
    ...
    int ra = static_cast<int>(water_radius * prog);
...
int InteractiveButtonBase::quick_sqrt(long X) const {
    ...
    return fu ? -X : X;
#endif
    auto M = static_cast<unsigned long>(X);
    unsigned int N, i;
...
QIcon::Mode InteractiveButtonBase::getIconMode() const {
    return isEnabled()
               ? (getState() ? QIcon::Selected : (hovering || pressing ? QIcon::Active : QIcon::Normal))
               : QIcon::Disabled;
}
...
void InteractiveButtonBase::anchorTimeOut() {
        ...
        for (int i = 0; i < waters.size(); i++) {
            ...
            if (water.finished) // 结束状态
            {
                water.progress = static_cast<int>(
                    100 - 100 * (timestamp - water.finish_timestamp) / water_finish_duration);
                if (water.progress <= 0) {
                    waters.removeAt(i--);
            ...
            } else // 正在出现状态
            {
                ...
                } else // 动画中的
                {
                    ...
                    {
                        water.progress = static_cast<int>(
                            100 * (timestamp - water.press_timestamp) / water_press_duration);
                    }
    ...
    } else if (anchor_pos != mouse_pos) // 移动效果
    {
        ...
        effect_pos.setY((geometry().height() >> 1) + offset_pos.y());
               ...
               && !click_ani_appearing && !click_ani_disappearing && jitters.empty() && waters.empty()
