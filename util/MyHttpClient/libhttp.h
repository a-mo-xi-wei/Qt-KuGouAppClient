...
public:
    ...
    // 新增重载方法，带 token 参数
    Q_INVOKABLE QString UrlRequestPost(const QString& url, const QString& data, const QString& token,
    ...
    Q_INVOKABLE QString UrlRequestGet(const QString& url, const QString& data, const QString& token,
                                      int timeout = 500000);
